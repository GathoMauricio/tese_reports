                    ...
                    <div class="card-body">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-header"><a href="#">Catálogo Administradores</a></div>
                                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-header"><a href="#">Catálogo Alumnos</a></div>
                                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-header"><a href="#">Activar | Desactivar Parciales</a></div>
                                        <div class="card-body">
